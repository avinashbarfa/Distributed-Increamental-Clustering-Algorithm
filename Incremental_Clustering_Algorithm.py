...
#Read the Data
read_clustered_data_1 = pd.read_excel("Clusterd_Data.xlsx",sheet_name='Cluster 1')
read_clustered_data_2 = pd.read_excel("Clusterd_Data.xlsx",sheet_name='Cluster 2')
...
temp = 0
for i in range(row_total.size-1):
    for j in range(i+1,row_total.size-1):
...
df16 = pd.DataFrame.append(pd.DataFrame.copy(read_clustered_data_1),pd.DataFrame.copy(df16))
df17 = pd.DataFrame.append(pd.DataFrame.copy(read_clustered_data_2),pd.DataFrame.copy(df17))
df18 = pd.DataFrame.append(pd.DataFrame.copy(read_clustered_data_3),pd.DataFrame.copy(df18))
df19 = pd.DataFrame.append(pd.DataFrame.copy(read_clustered_data_4),pd.DataFrame.copy(df19))
